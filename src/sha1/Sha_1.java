...
//		System.out.println(a);
	File file = new File("I:/同花顺_20-04-29/block1-100");
		File[] files = file.listFiles();
...
/*			 	String sql = "update 同花顺上市公司详细情况2020_04_20_09_53_57 set firestore='I:/同花顺_20-04-29/block801-1300/"+temp.getName()+"',hash='"+sha+"' where block_id="+String.valueOf(i+801);//SQL语句  
			 	...
			 	System.out.println(temp.getName());//中文乱码？？
